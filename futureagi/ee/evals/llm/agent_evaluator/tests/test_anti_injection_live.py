"""Live LLM tests: AgentEvaluator output-schema adherence under adversarial criteria.
...
def _validate_result_schema(result_dict, output_type, choices):
    """Schema-only assertions. Verdict correctness checked elsewhere."""
...
def test_anti_injection_schema_holds(
